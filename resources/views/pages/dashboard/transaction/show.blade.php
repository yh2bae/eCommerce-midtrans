<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <h2 class="font-semibold text-lg text-gray-800 lrading-tight mb-5">Transaction Detail</h2>
            ...
            <h2 class="font-semibold text-lg text-gray-800 lrading-tight mb-5">Transaction Item</h2>
